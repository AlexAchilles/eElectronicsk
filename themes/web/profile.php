...
<h4 class="pt-sm-2 pb-1 mb-0 text-nowrap">Alexandre Achilles</h4>
<p class="mb-0">@Achilles</p>
...
<input class="form-control" type="text" name="name" placeholder="Alexandre Achilles" value="Alexandre Achilles">
</div>
</div>
<div class="col">
<div class="form-group">
<label>Username</label>
<input class="form-control" type="text" name="username" placeholder="Achilles" value="Achilles">
</div>
</div>
</div>
<div class="row">
...
<div class="form-group">
<label>Email</label>
<input class="form-control" type="text" placeholder="alex@gmail.com">
</div>
</div>
</div>
<div class="row">
...
<span><a href="<?= url("/login");?>">Logout</a></span>
</button>
</div>
</div>
</div>
